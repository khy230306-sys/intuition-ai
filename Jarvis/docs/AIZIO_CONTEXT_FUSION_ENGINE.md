...
## API
- `fuseContext()` / `formatFusedContextSummary()` / `answerPriorityQuestion()`
## Principles
No invented fields · per-source confidence · cache TTL · AI redact via privacyBoundary
