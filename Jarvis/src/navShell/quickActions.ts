...
export const QUICK_ACTION_CATALOG: QuickActionDef[] = [
  ...
  { id: 'screen-record', title: '화면녹화', sub: '보이는 화면', ico: 'R', kind: 'view', payload: 'screen-record' },
  ...
  { id: 'family', title: '멤버', sub: '채팅 · 초대', ico: 'H', kind: 'view', payload: 'family' },
  { id: 'weather', title: '날씨', sub: '지금 기온', ico: 'W', kind: 'cmd', payload: '오늘 날씨 알려줘' },
  { id: 'friends', title: '멤버', sub: '멤버 공간', ico: 'P', kind: 'view', payload: 'family' },
