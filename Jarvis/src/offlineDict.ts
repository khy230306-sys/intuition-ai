...
const KO_EN: Dict = {
  ...
  잠깐만요: 'Just a moment',
  기다려주세요: 'Please wait',
  // Conversational / mood (translation-mode everyday lines)
  오늘기분이좀꿀꿀하네: 'I am feeling a bit down today',
  뭐하고있었어: 'What were you doing?',
  나오늘저녁뭐먹을까: 'What should I eat for dinner today?',
  오늘날씨가정말좋다: 'The weather is really nice today',
  오늘날씨정말좋다: 'The weather is really nice today',
  오늘날씨가정말좋네: 'The weather is really nice today',
  울산날씨알려줘: 'Please tell me the weather in Ulsan',
  스트레스받을때어떻게해: 'What should I do when I am stressed?',
  배고파: 'I am hungry',
  심심해: 'I am bored',
  잘자: 'Good night',
  진짜: 'Really?',
  다시말해줘: 'Please say that again',
  짧게말해줘: 'Please keep it short',
  자세히알려줘: 'Please tell me in detail',
  아니그거말고: 'No, not that',
  그거말고: 'Not that',
  번역해: 'Please translate',
  영어로: 'In English',
  그만: 'Stop',
  알겠어: 'Got it',
  고마워정말: 'Thank you so much',
  조금만기다려줘: 'Please wait a little',
  나중에얘기하자: 'Let us talk later',
  지금바빠: 'I am busy right now',
  어디야: 'Where are you?',
  ...
  비와: 'It is raining',
  비옴: 'It is raining',
  우산필요해: 'I need an umbrella',
  도와줘: 'Please help me',
  같이가자: 'Let us go together',
  여기서만나자: 'Let us meet here',
  ...
  이해했어: 'I understand',
  모르겠어: "I don't know",
  생각해볼게: 'I will think about it',
  괜찮으면그렇게하자: 'If that is okay, let us do that',
  조금더싸게할수없어: 'Can you make it a bit cheaper?',
  다른방법은: 'Is there another way?',
  이중에서뭐가제일나아: 'Which one is the best among these?',
  사진이거뭐야: 'What is this photo?',
  이거번역해줘: 'Please translate this',
  얼마예요: 'How much is it?',
  얼마에요: 'How much is it?',
  계산해주세요: 'Check please',
  메뉴판주세요: 'Menu please',
