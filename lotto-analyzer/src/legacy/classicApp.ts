    ...
    <header class="hero">
      ...
      <div class="wrap hero-wrap">
        <nav class="nav">
          ...
          <button type="button" class="btn btn-ghost" id="back-v3">← 3.0</button>
        </nav>
        <div class="hero-copy">
...
function bind() {
  document.querySelector('#back-v3')?.addEventListener('click', () => {
    window.dispatchEvent(new CustomEvent('lottolens:open-v3'))
  })
...
export function mountClassicApp(el: HTMLElement): void {
  app = el as HTMLDivElement
  render()
}
